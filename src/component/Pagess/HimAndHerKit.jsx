...
const HimAndHerKit = () => {
  ...
  return (
    ...
    <div className="travel_txt">Him And Her Kit</div>      
    </div>
    ...
    <div className="container travel_kit">
        ...
        <div className="col-lg-7 text_kit">
          <h3 className="text-center1">
            {" "}
            Create Your Him And Her Kit in few steps{" "}
          </h3>
          ...
          <div className={tabKit == 11 ? "show-content" : "content"}>
            ...
            {isOpen1 && (
              ...
              <div className="steps_kit mt-4">
                <h5>Select Your Him fragrance</h5>
                {selectedImage1 && (
              ...
              <div className="steps_kit mt-4">
                <h5>Select Your Her fragrance</h5>
                {selectedImage2 && (
                  <div className="contained">
                    <img
                      src={selectedImage2}
