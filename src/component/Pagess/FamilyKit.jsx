...
const FamilyKit = () => {
  ...
  const handleClick3 = (img) => {
    setSelectedImage3(img);
    setshowGraph(!showGraph);
  };
  const handleClick4 = (img) => {
    setSelectedImage4(img);
    setshowGraph(!showGraph);
  };
  ...
  // const handleClick3 = (img) => {
  //   setSelectedImage3(img);
  //   setIsOpen3(false); // Close sidebar after selecting an image
  // };
  ...
  return (
    ...
    <div className="travel_txt"> Family kit</div>      
    </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 text_kit">
              <h3 className="text-center1">
                {" "}
                Create Your Family Kit in few steps{" "}
              </h3>
              ...
              <div className={tabKit == 11 ? "show-content" : "content"}>
                <div>
                  ...
                  {isOpen3 && (
                    <div className={`sidebar1 ${isOpen3 ? "open" : ""}`}>
                      <div className="select_kit">
                        <div className="ms-3 select_kitinnerbox">
                          <button
                            className="close-btn"
                          ...
                          <h2 className="head mt-3 mb-3">
                            Choose your First Child Fragrance
                          </h2>
                            ...
                            <div className="row mt-4">
                              ...
                              <div className="fragnace_kit col-lg-2 col-4">
                                <img
                                  src={img1}
                                  alt="img"
                                  onClick={() => handleClick3(img1)}
                                  className={
                                    selectedImage3 === img1 ? "selected" : ""
                                  }
                                />
                              </div>
                              <div className="fragnace_kit col-lg-2 col-4">
                              ...
                              <div className="fragnace_kit col-lg-2 col-4">
                                <img
                                  src={img2}
                                  alt="img2"
                                  onClick={() => handleClick3(img2)}
                                  className={
                                    selectedImage3 === img2 ? "selected" : ""
                                  }
                                />
                              </div>
                            </div>
                  ...
                  {/*second child */}
                  {isOpen4 && (
                    <div className={`sidebar1 ${isOpen4 ? "open" : ""}`}>
                      <div className="select_kit">
                        <div className="ms-3 select_kitinnerbox">
                          <button
                            className="close-btn"
                          ...
                          <h2 className="head mt-3 mb-3">
                            Choose your Second Child Fragrance
                          </h2>
                            ...
                            <div className="row mt-4">
                              ...
                              <div className="fragnace_kit col-lg-2 col-4">
                                <img
                                  src={img1}
                                  alt="img"
                                  onClick={() => handleClick4(img1)}
                                  className={
                                    selectedImage4 === img1 ? "selected" : ""
                                  }
                                />
                              </div>
                              <div className="fragnace_kit col-lg-2 col-4">
                              ...
                              <div className="fragnace_kit col-lg-2 col-4">
                                <img
                                  src={img2}
                                  alt="img2"
                                  onClick={() => handleClick4(img2)}
                                  className={
                                    selectedImage4 === img2 ? "selected" : ""
                                  }
                                />
                              </div>
                            </div>
                  ...
                  <div className="steps_kit mt-4">
                    <h5>Select Your Mother fragrance</h5>
                    {selectedImage1 && (
                  ...
                  <div className="steps_kit mt-4">
                    <h5>Select Your Father fragrance</h5>
                    {selectedImage2 && (
                      <div className="contained">
                        <img
                          src={selectedImage2}
                  ...
                  <div className="steps_kit mt-4">
                    <h5>Select Your First Child fragrance</h5>
                    {selectedImage3 && (
                      <div className="contained">
                        <img
                          src={selectedImage3}
                ...
                {/*Second child */}
                <div className="steps_kit mt-4">
                <h5>Select Your second Child fragrance</h5>
                {selectedImage4 && (
                  <div className="contained">
                    <img
                      src={selectedImage4}
              ...
              <div className="Scent_image">
                  <div className="row ">
                    ...
                    <div className="col-lg-4 scent_kit_img2 text-center" onClick={() => handleTabKitImg(444)}><img src={img1} /><p>Lavender</p></div>
                    <div className="col-lg-4 scent_kit_img2 text-center" onClick={() => handleTabKitImg(555)}><img src={img3} /><p>Lavender</p></div>
                  </div>
              </div>
              <div className="ScentImgOuterBox2 mt-3">
                 <div className="text-center align-center ScentImgInnerBox2">
