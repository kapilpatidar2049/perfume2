...
const Create_perfume = () => {
  ...
  const toggleFamilyFilter = () => {
    setShowFamilyFilter(!showFamilyFilter);
  };
  // ADd to cart
  ...
  return (
    ...
    <div className="travel_txt">Create your own perfume</div>      
    </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 text_kit">
              <h3 className="text-center1">
                {" "}
                Create Your Personalized in few steps{" "}
              </h3>
                ...
                <div className="showgraph">
                  <div className="row">
                    <div className="col-lg-5 ms-4">
                      ...
                      <div className="TravelKit_video mb-5">
                        <video
      ...
      <div className={tabKitImg == 333 ? "show-content" : "content"}>
        ...
        {/****************** Start Banner img dual section and link ****************************/}
        <div className="container dual_imgg">
          <div className="row">
            <div className="col-lg-6 dual_txt">
              <h1>20% OFF ON DUAL PERFUME CRAYON</h1>
              <h6 className="mt-4">Try your unique personality scents with our Dual Perfume Crayon. Select your two scents from the options above.</h6>
              <button className="dual_btn">All Products</button>
            </div>
            <div className="col-lg-6"></div>
          </div>
        </div>
        {/****************** End Banner img dual section and link ****************************/}
        {/****************** Start Banner img Quiz section and link ****************************/}
        <div className="container quiz_imgg">
          <h1>DISCOVER YOUR OWN PERSONALIZED PERFUME</h1>
          <h6>Choose From Over 30 Exclusive Scents And Design Your Bottle</h6>
          <button className="quiz_btn" > Quizes </button>
        </div>
        {/****************** End Banner img Quiz section and link ****************************/}
        ...
        <div className="container review ">
          ...
          <div className="comment">
            <input
              ...
              className="input_type_kit"
            />
            <button className="Submit_btn_kit"> Submit </button>
          </div>
          <div className="row mt-4">
